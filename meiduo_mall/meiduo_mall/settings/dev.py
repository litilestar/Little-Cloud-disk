...
SECRET_KEY = 'a@%n=!p!6@0_bs6_5ua_f5o1&8db^7_au@nuv3m&!k2=ia4ouw'
...
REST_FRAMEWORK = {
    ...
    # 分页
    'DEFAULT_PAGINATION_CLASS': 'meiduo_mall.utils.paginations.StandardSetResultPaginations',
}
# DRF扩展
